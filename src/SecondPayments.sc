theme: /SecondPayment
    ...
    state: TransferPoint           
        ...
        state: HowFindContacts
            ...
            intent: /WhichPlace
            if: $session.nesoglasie == 1
                a: Вам нужно обратиться с заявлением к каждому поставщику услуг. Контакты поставщиков Вы можете найти в квитанции, либо на нашем сайте alseco.kz
                go!: /SecondPayment/TransferPoint/Agreement/Требование_дальнейшей_консультации
            else:
        ...
        state: ReturnDate
            intent: /ReturnDate
            if: $session.nesoglasie==1
                a:Возвраты осуществляют только поставщики услуг. Обратитесь к ним
                go!: /SecondPayment/TransferPoint/Agreement/Требование_дальнейшей_консультации 
            else:
                a: Срок возврата уточните  у банка, через который производилась оплата. Он зависит только от них
                go!: /SecondPayment/TransferPoint/Agreement/Требование_дальнейшей_консультации 
