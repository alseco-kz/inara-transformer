theme: /ChangeAccountPersonCount
    ...
    state: ChangeAccountPersonCountQuestion
        a: Вы можете сменить количество зарегистрированных проживающих в квитанции по основным услугам или в графе вывоз ТэБэ, О. Где бы вы хотели сменить количество?\
        a: О
